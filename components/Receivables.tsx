  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 h-[calc(100vh-140px)] overflow-y-auto custom-scrollbar">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        ...
        <div className="flex items-center bg-[#1e2e41] p-1 rounded-lg border border-[#1687cb]/20">
          ...
          <div className="bg-[#1e2e41] rounded-2xl border border-[#1687cb]/10 overflow-hidden flex flex-col shadow-lg">
              <div className="p-4 bg-[#111623]/30 border-b border-[#1687cb]/10 flex justify-between items-center">
                  <div className="flex items-center gap-2 text-white font-bold">
                      ...
                      <h3>A Receber ({months[currentMonth]})</h3>
                  </div>
                  <span className="bg-[#20bbe3]/20 text-[#20bbe3] text-xs font-bold px-2 py-1 rounded-full">
              ...
              <div className="p-4 space-y-3 max-h-[300px] overflow-y-auto custom-scrollbar">
                  {pendingThisMonthList.length === 0 ? (
                      ...
                      pendingThisMonthList.map(plan => {
                          ...
                          return (
                            <div key={plan.id} className="flex items-center justify-between bg-[#111623] p-3 rounded-xl border border-[#1687cb]/10 hover:border-[#20bbe3]/30 transition-colors">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-[#1e2e41] flex items-center justify-center text-[#20bbe3] font-bold border border-[#1687cb]/20">
      ...
      <div className="bg-[#1e2e41] rounded-2xl border border-[#1687cb]/10 overflow-hidden shadow-xl mt-6">
         <div className="p-4 bg-[#111623]/30 border-b border-[#1687cb]/10 flex justify-between items-center">
            ...
            {/* Search */}
            <div className="flex items-center bg-[#111623] px-3 py-1.5 rounded-lg border border-[#1687cb]/20 focus-within:border-[#20bbe3]/50 transition-colors w-64">
            ...
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="bg-[#111623] text-slate-400 text-xs uppercase font-semibold border-b border-[#1687cb]/20">
                        <th className="p-4 sticky left-0 bg-[#111623] z-10 w-[250px] shadow-[2px_0_5px_rgba(0,0,0,0.3)]">Cliente / Plano</th>
                        ...
                        return (
                            <tr key={plan.id} className="hover:bg-[#111623]/30 transition-colors group">
                                <td className="p-4 sticky left-0 bg-[#1e2e41] group-hover:bg-[#182433] transition-colors z-10 border-r border-[#1687cb]/10 shadow-[2px_0_5px_rgba(0,0,0,0.3)]">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#1687cb] to-[#20bbe3] p-[1px]">
                                            <img src={client?.avatar} alt="" className="w-full h-full rounded-full bg-[#111623] object-cover" />
                                        </div>
                                        <div>
                                            <p className="font-bold text-white leading-tight">{client?.company}</p>
                                            <p className="text-[10px] text-slate-400">{plan.title}</p>
                                        </div>
                                    </div>
                                </td>
